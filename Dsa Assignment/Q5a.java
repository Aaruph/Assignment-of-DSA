...
public class Q5a {
    ...
    public Q5a(double[][] distances, int numAnts, int numIterations, double decayFactor, double alpha, double beta) {
    ...
    public static void main(String[] args) {
        ...
        Q5a antColony = new Q5a(distances, numAnts, numIterations, decayFactor, alpha, beta);
        antColony.solve();
